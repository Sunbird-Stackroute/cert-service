...
public class HTMLVarResolver {
    ...
    public String getLogoImage1() {
        return certificateExtension.getLogoImage1();
    }

    public String getLogoImage2() {
        return certificateExtension.getLogoImage2();
    }

    public String getFileName(){
        return  certificateExtension.getFileName();
    }


    public String getCertify() {
        return certificateExtension.getCertify();
    }

    public String getTextBeforeCourse() {
        return certificateExtension.getTextBeforeCourse();
    }

    public String getTextAfterCourse() {
        return certificateExtension.getTextAfterCourse();
    }
    ...
    public Map<String, String> getCertMetaData() {
        ...
        try {
            ...
            metaData.put(JsonKey.LOGO_IMAGE1,urlEncode(getLogoImage1()));
            metaData.put(JsonKey.LOGO_IMAGE2,urlEncode(getLogoImage2()));
            metaData.put(JsonKey.CERTIFY,urlEncode(getCertify()));
            metaData.put(JsonKey.TEXT_BEFORE_COURSE,urlEncode(getTextBeforeCourse()));
            metaData.put(JsonKey.TEXT_AFTER_COURSE,urlEncode(getTextAfterCourse()));
            metaData.put(JsonKey.FILENAME,urlEncode(getFileName()));
